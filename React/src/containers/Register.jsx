        ...
        return(<>
            <form className="form-register">
                <div className="website-conditions">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam cupiditate deserunt assumenda, blanditiis iure in impedit iusto fuga sapiente saepe provident ipsa eos quisquam voluptatum placeat quaerat nostrum veniam eaque!
                    ...
                    Laborum doloremque quasi ad dignissimos eos omnis sunt, totam eius nam ipsum optio similique voluptatem facilis error, porro fugiat natus in quibusdam voluptate sint officia. Illo animi non atque modi?</p>
                    <p>Provident eaque nostrum consequatur ratione minus, maxime, dolor eum amet ipsum consectetur asperiores quia eius praesentium neque dolorum perferendis facilis nulla nobis odit? Consequuntur earum ab in consequatur blanditiis molestias?
                    ...
                    Dolorum natus mollitia saepe earum tempore nemo commodi enim eveniet quis sunt quam eum, repellendus culpa animi tenetur eaque voluptas, eligendi deserunt! Possimus voluptas aliquid, amet dolore natus aut quae!</p>
                    <p>Quibusdam iure, veniam repellat similique assumenda, corporis eligendi minus maiores fuga nulla atque doloribus quas, voluptatem distinctio aliquid tempore! Atque recusandae distinctio minima! Corporis cupiditate doloremque dolores debitis voluptate deserunt?
                    ...
                    Hic nulla natus eum debitis ullam similique delectus impedit magni asperiores, enim distinctio animi necessitatibus nihil quibusdam dolor. Quam vel necessitatibus ipsa sit exercitationem modi veniam iste sapiente eveniet unde!</p>
                    <p>Repellendus ad ut magni, eveniet nemo animi error fuga? Sint explicabo repellat animi repudiandae a qui, iste temporibus blanditiis nemo? Vero nesciunt obcaecati ab. Exercitationem enim aut culpa illo minima?
                    ...
                    Cupiditate eaque dolorum exercitationem, beatae nisi porro nulla at dignissimos molestiae qui omnis voluptas officia officiis ut delectus laudantium pariatur nemo laborum libero reiciendis eum modi perspiciatis architecto! Ipsum, voluptatum!</p>
                    <p>Temporibus quae explicabo odit accusamus similique. Nihil libero nulla esse, ducimus soluta harum sapiente molestias, architecto rerum ipsam accusamus expedita est quam a ut odio! Maiores rerum fuga voluptate necessitatibus?
                    ...
                    Nemo eaque, deserunt doloremque iste corrupti voluptates. Saepe, rerum impedit minus velit, quia id iure cum ex neque cupiditate, vitae eos! Doloribus deleniti nobis fugit veritatis, excepturi eos quam accusamus!</p>
                    <p>Ducimus minus, enim magni incidunt inventore explicabo neque ad. Quae cumque esse temporibus nihil dolores, voluptatem modi itaque cupiditate repudiandae eveniet perferendis enim sunt nisi commodi eius atque. Enim, vel.
                    ...
                    Provident inventore mollitia officia laudantium optio adipisci voluptas ipsa? Deleniti vitae ut iste odit accusantium in illo dicta quae ratione expedita tempora nesciunt optio perferendis exercitationem eos, tenetur esse excepturi!</p>
                    <p >
                    Officiis quos commodi, molestiae expedita autem est aspernatur ipsam molestias porro nobis tempore obcaecati corporis suscipit aliquid, eligendi delectus in velit laudantium. Omnis, nobis laudantium. Obcaecati iure totam est voluptas.</p>
                </div>
                <fieldset>
            ...
            <fieldset>
                ...
                <button onClick={(e) => this.postUserFromForm(e)}>Register</button>
            </form>
        </>)
    }
}
